...
Architecture:
- CPU-based implementation using CatBoost for classification.
...
def visualize_classification_map(classification_map, dataset_name):
    ...
    os.makedirs('maps/2.proposed_algo_CPU', exist_ok=True)
    filepath = os.path.join('maps/2.proposed_algo_CPU', f"{dataset_name}_classification_map.png")
